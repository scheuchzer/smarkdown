...
@Slf4j
@AllArgsConstructor
public class GitHubListingProvider {

	public List<String> getDocuments(final List<GitHubLocation> locations) {
		final List<String> documents = new ArrayList<String>();
		log.info("Starting listing from {} locations", locations.size());
		for (final GitHubLocation location : locations) {
	...
	private List<String> getDocuments(final GitHubLocation location) {
		final List<String> documents = new ArrayList<String>();
		try {
